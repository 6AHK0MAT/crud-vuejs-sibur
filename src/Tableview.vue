    ...
    export default {
        ...
        methods: {
            ...
            loadTask() {
                ...
                this.$http.get(`/tasks?_${qString}`).then(
                    response => {
            ...
            removeTask(tasks) {
                ...
                swal({
                    ...
                    self.$http.delete(`/tasks/${tasks.id}`).then(
                        result => {
            ...
            saveTask() {
                if (this.selected.id != null) {  //EDIT
                    this.$http.put(`/tasks/${this.selected.id}`, this.selected).then(
                        response => {
                            this.$set('selected', {})
                    ...
                    this.$http.post(`/tasks`, this.selected).then(
                        response => {
                            this.$set('selected', {})
                            this.$set('showModal', false)
                        },
